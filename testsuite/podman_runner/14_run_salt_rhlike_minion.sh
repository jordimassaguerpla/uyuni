...
sudo -i podman exec -d prometheus-apache_exporter
sudo -i podman exec -d -e DATA_SOURCE_NAME="postgresql://user:passwd@localhost:5432/database?sslmode=disable" prometheus-postgres_exporter
